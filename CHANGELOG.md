...
- **Theme mode selection**: Added light/dark theme mode support.
- **Grid spacing controls**: Added grid spacing preview with stronger validation and input handling.
- **Richer object editing**: Added object rotation controls and room dimension editing.
...
- Fixed measurement refresh inconsistencies.
- Fixed export reliability issues.
- Fixed autosave reliability issues.
- Fixed mobile drag behavior.
- Fixed service worker offline fallback handling to avoid invalid `respondWith` responses.
